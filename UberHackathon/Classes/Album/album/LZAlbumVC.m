...
-(XHPathCover*)albumHeaderPathCover{
    if(_albumHeaderPathCover==nil){
        ...
        [_albumHeaderPathCover.avatarButton sd_setImageWithURL:[NSURL URLWithString:avatar.url] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"image_placeholder"]];
