...
-(void)setAlbum:(LZAlbum *)album{
    ...
    [self.avatarImageView sd_setImageWithURL:[NSURL URLWithString:album.avatarUrl] placeholderImage:[UIImage imageNamed:@"avator"]];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [photoCell.photoImageView sd_setImageWithURL:[NSURL URLWithString:photo.actualThumbnailUrl] placeholderImage:[UIImage imageNamed:@"image_placeholder"]];
